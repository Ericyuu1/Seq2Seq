...
def _parse_args():
    ...
    parser.add_argument('--test_output_path', type=str, default='geo_test_output3.tsv', help='path to write blind test results')
    ...
    parser.add_argument('--with_attention', dest='with_attention',default=False,action='store_true',help='run the model with attention')
...
if __name__ == '__main__':
    ...
    evaluate(test_data_indexed, decoder, print_output=False, outfile="geo_test_output3.tsv")